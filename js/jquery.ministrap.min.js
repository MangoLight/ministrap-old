...
a(".carousel").each(function(){var f=a(this).attr("data-arrows");f&&("true"==f?f=!0:f=!1);var g=a(this).attr("data-indicators");g&&("true"==g?g=!0:g=!1);var c=a(this).attr("data-auto");c&&("true"==c?c=!0:c=!1);var e=a(this).attr("data-auto");e&&(e=parseInt(e));var b=a(this).attr("data-stoponhover");b&&("true"==b?b=!0:b=!1);a(this).miniCarousel({mode:a(this).attr("data-mode"),arrows:f,indicators:g,auto:c,delay:e,stoponhover:b})});a(".to-top").miniToTop();a("[data-modal]").miniModal();a("[data-hint]").miniHint();
