...
(function(a){a.fn.miniModal=function(g){function f(b,c){b.bind("open",function(){b.addClass("opened");c.stop().fadeIn("fast",function(){b.css({top:0,left:a(window).width()/2-b.width()/2,opacity:0}).show().stop().animate({top:70,opacity:1},function(){e(b)})}).click(function(){d(b,c)})});a(window).resize(function(){b.css({left:a(window).width()/2-b.width()/2});e(b)})}function d(b,c){b.stop().animate({top:-50,opacity:0},"fast",function(){a(this).hide();a(this).hasClass("ajax")&&a(this).remove();c.stop().fadeOut()})}
function e(b){void 0===b.attr("data-fixed-top")&&b.attr("data-fixed-top",parseInt(b.css("top")));b.height()+parseInt(b.attr("data-fixed-top"))>a(window).height()?b.css({position:"absolute",top:a(window).scrollTop()+parseInt(b.attr("data-fixed-top"))}):b.css({position:"fixed",top:parseInt(b.attr("data-fixed-top"))})}a.extend({background:!0},g);return this.not(".miniModal").each(function(){a(this).addClass("miniModal");var b=a(this),c=b.attr("data-modal"),e=a("<div>").addClass("modal-bg").appendTo("body");
0==c.indexOf("#")||0==c.indexOf(".")?(c=a(c).appendTo("body"),0<c.length&&(f(c,e),b.click(function(){c.trigger("open");return!1}),c.bind("close",function(){d(c,e)}),c.find(".close").click(function(){d(c,e)}))):b.click(function(){a.ajax({url:b.attr("href"),success:function(c){var h=a("<div>").addClass("modal ajax").appendTo("body");""!=b.attr("data-title")&&a("<div>").addClass("modal-title").html("<h5>"+b.attr("data-title")+'</h5> <div class="close">&times;</div>').appendTo(h);a("<div>").addClass("modal-content").html(c).appendTo(h);
f(h,e);h.trigger("open");h.bind("close",function(){d(h,e)});h.find(".close").click(function(){d(h,e)})}});return!1})})}})(jQuery);
(function(a){a.fn.miniCarousel=function(g){function f(a,c){a.find(".carousel-indicators div").removeClass("active");a.find(".carousel-indicators div").eq(c).addClass("active")}function d(b,c){b.each(function(){a(this).css({width:c.width()})})}var e=a.extend({arrows:!0,indicators:!0,auto:!0,delay:5E3},g);return this.each(function(){var b=a(this),c=a(this).find("ul").eq(0),k=a(this).find("ul li");c.css({width:"999999px"});d(k,b);e.arrows&&(a("<div>").html("&lsaquo;").addClass("carousel-control left").appendTo(b).click(function(){b.trigger("slidePrev")}),
a("<div>").html("&rsaquo;").addClass("carousel-control right").appendTo(b).click(function(){b.trigger("slideNext")}));if(e.indicators){for(var g=a("<div>").addClass("carousel-indicators").appendTo(b),h=0;h<k.length;h++)a("<div>").click(function(){b.trigger("slideTo",a(this).attr("data-slide"))}).appendTo(g).attr("data-slide",h);f(b,0)}if(e.auto){var l=window.setInterval(function(){b.hasClass("hover")||b.trigger("slideNext")},e.delay);b.hover(function(){b.addClass("hover");clearInterval(l)},function(){b.removeClass("hover");
l=window.setInterval(function(){b.hasClass("hover")||b.trigger("slideNext")},e.delay)})}a(window).resize(function(){d(k,b);c.stop().css({"margin-left":0});e.indicators&&f(b,0)});b.bind("slideTo",function(a,d){0<b.find("ul li").eq(d).length&&0<=d&&c.animate({"margin-left":-1*d*b.width()},function(){e.indicators&&f(b,d)})});b.bind("slidePrev",function(){var a=parseInt(-1*parseInt(b.find("ul").css("margin-left").replace("px"))/b.width()),c=b.find("li").length;0===a?a=c-1:a--;b.trigger("slideTo",a)});
...
10,h="top"));c.addClass("minihint-"+h);a("<div>").addClass("minihint-arrow-"+h+"-border").appendTo(c);var l=a("<div>").addClass("minihint-arrow-"+h);l.css("border-"+h+"-color",c.css("background-color"));l.appendTo(c);c.css({top:f,left:g})}function d(a){return a.height()+parseInt(a.css("padding-top"))+parseInt(a.css("padding-bottom"))}function e(a){return a.width()+parseInt(a.css("padding-left"))+parseInt(a.css("padding-right"))}var b=a(this),c=a("<div>").addClass("minihint").hide().appendTo("body");
b.attr("data-hint-class")&&c.addClass(b.attr("data-hint-class"));a(window).load(function(){f();if("true"==b.attr("data-hint-permanent"))c.show(),a(window).resize(function(){f()}),a(document).change(function(){f()});else{var d;b.hover(function(){clearTimeout(d);console.log("init timeout");f();console.log(c);c.css({display:"block",opacity:0}).animate({opacity:1})},function(){d=setTimeout(function(){console.log("fin timeout");c.animate({opacity:0})},500)})}})})}})(jQuery);
